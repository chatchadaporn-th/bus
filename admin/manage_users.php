    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800" style="font-weight:bold;"> <i class="fas fa-fw fas fa-user-edit"></i> จัดการสมาชิก</h1>
                </div>
            <!-- DataTales Example -->
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <?php
                          $num=1;
                          $sqlmana_users= "SELECT * FROM tbl_users WHERE u_status =1";
