    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800" style="font-weight:bold;"> <i class="fas fa-fw fas fa-users-cog"></i> จัดการแอดมิน</h1>
                </div>
            <!-- DataTales Example -->
                <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">จัดการแอดมิน</h6>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <?php
                          $num=1;
                          $sqlmana_users= "SELECT * FROM tbl_users WHERE u_status =2";
                          $resultmana_users = mysqli_query($conn, $sqlmana_users);
                          while ($datauser = mysqli_fetch_array($resultmana_users)) {
                        ?>
                        <tr>
                            <td><?php echo $num ?></td>
                            <td><?php echo $datauser['u_username']; ?></td>
                            <td><?php echo $datauser['u_password']; ?></td>
                            <td><?php echo $datauser['u_name']; ?></td>
                            <td><?php echo $datauser['u_tel']; ?></td>
                            <td>
                              <a class="btn btn-success btn-sm" href="edit_user.php?m_id=<?php echo $datauser['u_id']; ?>" ><i class="fas fa-pencil-alt fa-fw"></i><b>Edit &nbsp;</b></a>
                            </td>
                        </tr>
                          <?php
                          $num++; } ?>
