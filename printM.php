        ...
        <div class="container">
                <div class="card" style="background-color: #ffffff; font-family: 'Kanit', sans-serif;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="w-100"><h6 class="card-title" style="font-family: 'Kanit', sans-serif;"><span  style="color:#f44336; font-family: 'Kanit', sans-serif;"> สามารถตรวจสถานะการจองได้ที่ </span><a href="payment.php" class="alert-link">การชำระเงิน</a></h6></div> 
                        <form method="POST" action="printsearch.php">
